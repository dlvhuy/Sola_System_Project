...
export default function Modal({ title, sendOpenModal, children }: {
    ...
    return (
        <div className="z-20 m-0 fixed inset-0 bg-black/50 flex items-center justify-center transition-all duration-600 ease-out opacity-0 translate-y-[-20px] animate-slide-down">
